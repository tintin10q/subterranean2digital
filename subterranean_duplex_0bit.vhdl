...
entity main is
  port (
    ...
    OutState_0_63: out std_logic_vector(63 downto 0);
    OutState_64_127: out std_logic_vector(63 downto 0);
    OutState_128_191: out std_logic_vector(63 downto 0);
    OutState_192_255: out std_logic_vector(63 downto 0);
    OutState_256: out std_logic);
end main;
...
begin
  gate0: entity work.Subterranean_round
    port map (
      ...
      n256 => state_256,
      o0_63 => s0,
      o64_127 => OutState_64_127,
      o128_191 => OutState_128_191,
      o191_255 => OutState_192_255,
      o256 => OutState_256);
  OutState_0_63(0) <= s0(0);
  OutState_0_63(1) <= ('1' XOR s0(1));
  OutState_0_63(63 downto 2) <= s0(63 downto 2);
end Behavioral;
